...
class CourseAdmin(admin.ModelAdmin):
    ...
    unpublish_courses.short_description = 'unpublished selected courses'

@admin.register(Module)
class moduleAdmin(admin.ModelAdmin):
    list_display = ['title', 'courses_link', 'order', 'lesson_count']
    list_filter = ['course']
    ...
    lesson_count.short_description = 'Lesson'
